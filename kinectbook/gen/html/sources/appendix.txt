...
OpenNIのインストール手順に載せたバージョンはもうダウンロードページから手に入らないので、最新版を利用してください。SensorKinect, OpenNI, NITE 全て新しいバージョンがリリースされました。

 - 2012年1月時点で、ボーントラッキングに初期ポーズは不要になり、Kinect SDK以上に使い勝手が良くなっています。
 - 対応OSにAndroidが追加されました。
